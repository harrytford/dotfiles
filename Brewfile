...
#tap 'homebrew/core' # no longer necessary
...
#brew 'exa'          # Listing files with info (better ls) - nope
...
#brew 'dog'          # DNS lookup client (better dig) # nope
...
#brew 'kdash'        # Kubernetes management # nothing
...
# Fonts
#tap 'homebrew/cask-fonts' # done
cask 'font-fira-code'
cask 'font-hack'
#cask 'font-inconsolata' # done
cask 'font-meslo-lg-nerd-font'

# Mac OS Quick-Look Plugins
cask 'qlcolorcode'    # QL for code with highlighting
#cask 'qlimagesize'    # QL for size info for images # done
...
#cask 'quicklookapk',   args: { require_sha: false } # QL for Android APKs # done
...
# brew 'lporg'          # Backup and restore launchpad layout #done
...
# brew 'skhd'           # Hotkey daemon for macOS #done
cask 'stats'          # System resource usage in menubar
# brew 'yabai'          # Tiling window manager # done
...
# oh my zsh isn't included in homebrew so this:
